...
/*
 Here I learn two things basically
 1. How to process boundary cells that is (marking all first and last column) & (marking first and last row)
 2. I learnt that instead of taking if-else i can use max(-negative, 0) if i dont want negative numbers
 */ 
